...
import com.msr.tensquare.user.service.AdminService;
...
public class AdminController {
    ...
    public Result login(@RequestBody Admin admin) {
        Admin savedAdmin = adminService.login(admin);
        if (ObjectUtils.isEmpty(savedAdmin)) {
            return new Result(false, StatusCode.LOGINERROR, "登录失败");
        }
        String token = jwtUtil.createJWT(savedAdmin.getId(), savedAdmin.getLoginname(), "admin");
